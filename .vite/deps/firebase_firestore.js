  ...
  j(e, t) {
    ...
    return new PersistencePromise((r, i) => {
      e.onerror = (e2) => {
        ...
        s.isDone ? r() : null === s.U ? i2.continue() : i2.continue(s.U);
      };
...
var __PRIVATE_IndexedDbIndexManager = class {
  ...
  Vn(e, t, n) {
    ...
    for (const s of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
      const e2 = n[i++];
      for (const n2 of r) if (this.bn(t, s.fieldPath) && isArray(e2)) r = this.Sn(r, s, e2);
      else {
  ...
  getFieldIndexes(e, t) {
    ...
    return (t ? n.G(be, IDBKeyRange.bound(t, t)) : n.G()).next((e2) => {
      const t2 = [];
  ...
  updateCollectionGroup(e, t, n) {
    ...
    return this.vn(e).next((e2) => r.G(be, IDBKeyRange.bound(t, t)).next((t2) => PersistencePromise.forEach(t2, (t3) => i.put(__PRIVATE_toDbIndexState(t3.indexId, this.uid, e2, n)))));
  }
  updateIndexEntries(e, t) {
...
var __PRIVATE_LruScheduler = class {
  ...
  er(e) {
    __PRIVATE_logDebug(St, `Garbage collection scheduled in ${e}ms`), this.Xn = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection", e, async () => {
      this.Xn = null;
      try {
        await this.localStore.collectGarbage(this.garbageCollector);
      } catch (e2) {
        __PRIVATE_isIndexedDbTransactionError(e2) ? __PRIVATE_logDebug(St, "Ignoring IndexedDB error during garbage collection: ", e2) : await __PRIVATE_ignoreIfPrimaryLeaseLoss(e2);
      }
      await this.er(3e5);
    });
  }
...
var __PRIVATE_SchemaConverter = class {
  ...
  B(e, t, n, r) {
    ...
    }(e)).next(() => this.hi(e, i)).next(() => e.deleteObjectStore(K))), n < 14 && r >= 14 && (s = s.next(() => this.Pi(e, i))), n < 15 && r >= 15 && (s = s.next(() => function __PRIVATE_createFieldIndex(e2) {
...
var __PRIVATE_WebStorageSharedClientState = class {
  ...
  async start() {
    ...
    for (const t2 of e) {
      ...
      if (e2) {
        const n = __PRIVATE_RemoteClientState.bs(t2, e2);
  ...
  addLocalQueryTarget(e, t = true) {
    ...
    if (this.isActiveQueryTarget(e)) {
      ...
      if (t2) {
        const r = __PRIVATE_QueryTargetMetadata.bs(e, t2);
        r && (n = r.state);
      }
    }
...
var __PRIVATE_WebChannelConnection = class extends __PRIVATE_RestConnection {
  ...
  Wo(e, t, n) {
    ...
    return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
      ...
      h || (h = true, __PRIVATE_logWarn(Wt, `RPC '${e}' stream ${r} transport errored:`, t2), P.Ko(new FirestoreError(C.UNAVAILABLE, "The operation could not be completed")));
      ...
      if (!h) {
        ...
        if (o2) {
          ...
          h = true, P.Ko(new FirestoreError(n3, i3)), c.close();
    ...
    try {
      await async function __PRIVATE_handleTargetError(e2, t2) {
        ...
        for (const r of t2.targetIds)
          e2.U_.has(r) && (await e2.remoteSyncer.rejectListen(r, n2), e2.U_.delete(r), e2.H_.removeTarget(r));
      }(e, t);
    } catch (n2) {
    ...
    */
    await function __PRIVATE_raiseWatchSnapshot(e2, t3) {
      ...
      n2.targetMismatches.forEach((t4, n3) => {
        ...
        if (!r)
          return;
        e2.U_.set(t4, r.withResumeToken(ByteString.EMPTY_BYTE_STRING, r.snapshotVersion)), // Cause a hard reset by unwatching and rewatching immediately, but
...
async function __PRIVATE_onWriteStreamClose(e, t) {
  t && __PRIVATE_ensureWriteStream(e).b_ && // This error affects the actual write.
...
async function __PRIVATE_syncEngineApplyPrimaryState(e, t) {
  ...
  if (__PRIVATE_ensureWatchCallbacks(n), __PRIVATE_syncEngineEnsureWriteCallbacks(n), true === t && true !== n.ja) {
    ...
    function __PRIVATE_resetLimboDocuments(e3) {
      ...
      }), t3.Ua.Dr(), t3.Ka = /* @__PURE__ */ new Map(), t3.$a = new SortedMap(DocumentKey.comparator);
  ...
  return e.asyncQueue.enqueueAndForget(async () => async function __PRIVATE_executeQueryFromCache(e2, t2, n2) {
    try {
      const r = await __PRIVATE_localStoreExecuteQuery(
        ...
        /* usePreviousResults= */
        true
      ), i = new __PRIVATE_View(t2, r.gs), s = i.Sa(r.documents), o = i.applyChanges(
        s,
        /* limboResolutionEnabled= */
        false
      );
...
function __PRIVATE_parseData(e, t) {
  ...
  if (
    ...
    return function __PRIVATE_parseArray(e2, t2) {
      ...
      let r = 0;
      for (const i of e2) {
        let e3 = __PRIVATE_parseData(i, t2.Uu(r));
